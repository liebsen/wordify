...
class Belief extends \Spot\Entity
{
    protected static $table = "beliefs";
    ...
    public static function fields()
    {
        return [
            ...
            "refocus_id" => ["type" => "integer", "length" => 10, "value" => 0],
            "text" => ["type" => "text"],
    ...
    {
        return [
            'refocus' => $mapper->belongsTo($entity, 'App\Refocus', 'refocus_id'),
        ];
    }

    public function transform(Belief $entity)
    {
        return [
